...
export declare class DevelopmentButler {
    ...
    constructor(checkpointDetector: CheckpointDetector, toolInterface: MCPToolInterface, learningManager?: LearningManager, memoryStore?: UnifiedMemoryStore);
    private initialize;
    ...
    recordUserResponse(requestId: string, _response: {
        accepted: boolean;
