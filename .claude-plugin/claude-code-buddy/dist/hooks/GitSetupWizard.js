...
import { GitAssistantHook } from './GitAssistantHook.js';
...
export class GitSetupWizard {
    ...
    async runFullSetup() {
        ...
        const automationLevel = Math.min(3, Math.max(0, parseInt(levelInput)));
        logger.info('');
    ...
    async mockUserInput(prompt, defaultValue) {
...
//# sourceMappingURL=GitSetupWizard.js.map