/**
 * Evolution Store Interface
 *
 * Defines the contract for evolution data storage implementations.
 * Implementations: SQLiteStore, PostgreSQLStore (future)
 */
...
export interface IEvolutionStore {
  ...
  listTasks(filters?: { status?: Task['status']; limit?: number; offset?: number }): Promise<Task[]>;
