...
export declare class SQLiteStore implements EvolutionStore {
    ...
    deactivatePattern(patternId: string, _reason?: string): Promise<void>;
    ...
    computePeriodStats(_periodType: 'hourly' | 'daily' | 'weekly' | 'monthly', _periodStart: Date, _periodEnd: Date): Promise<EvolutionStats[]>;
    ...
    getSkillRecommendations(_filters: {
        taskType: string;
        agentType?: string;
        topN?: number;
...
//# sourceMappingURL=SQLiteStore.basic.d.ts.map